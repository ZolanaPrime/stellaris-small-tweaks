...
$choice = Read-Host "Please select an option"
if($choice -eq 1){
$content[$line+70] = 'set_federation_law = allow_subjects_to_join_no }'
$content | Set-Content -Path $file
...
$choice = Read-Host "Please select an option"
if($choice -eq 1){
$content[$line+99] = 'set_federation_law = allow_subjects_to_join_no }'
$content | Set-Content -Path $file
...
$choice = Read-Host "Please select an option"
if($choice -eq 1){
$content[$line+82] = 'set_federation_law = allow_subjects_to_join_no }'
$content | Set-Content -Path $file
...
$choice = Read-Host "Please select an option"
if($choice -eq 1){
$content[$line+76] = 'set_federation_law = allow_subjects_to_join_no }'
$content | Set-Content -Path $file
