...
Write-Host "############ Version 1.7.1 #############"
$patcher_ver = "1.7.1"
Write-Host "########################################"
Write-Host "######## Patcher for Stellaris: ########"
Write-Host "############ v3.13.1 (Vela) ############"
$ver = "3.13.1"
Write-Host "########################################"
...
elseif ($choice -eq 1){
    ...
    $content[$line+26] = '		factor = 0' # Vultaum
    $content[$line2+27] = '		factor = 0' # Yuht
    $content[$line3+26] = '		factor = 0' # First League
    $content[$line4+26] = '		factor = 0' # Irassians
    $content[$line5+26] = '		factor = 1' # Cybrex
    $content | Set-Content -Path $file
...
elseif ($choice -eq 2){
    ...
    $content[$line+26] = '		factor = 0' # Vultaum
    $content[$line2+27] = '		factor = 0' # Yuht
    $content[$line3+26] = '		factor = 1' # First League
    $content[$line4+26] = '		factor = 0' # Irassians
    $content[$line5+26] = '		factor = 0' # Cybrex
    $content | Set-Content -Path $file
...
elseif ($choice -eq 3){
    ...
    $content[$line2+27] = '		factor = 0' # Yuht
    $content[$line3+26] = '		factor = 0' # First League
    $content[$line4+26] = '		factor = 1' # Irassians
    $content[$line5+26] = '		factor = 0' # Cybrex
    $content | Set-Content -Path $file
...
elseif ($choice -eq 4){
    ...
    $content[$line+26] = '		factor = 1' # Vultaum
    $content[$line2+27] = '		factor = 0' # Yuht
    $content[$line3+26] = '		factor = 0' # First League
    $content[$line4+26] = '		factor = 0' # Irassians
    $content[$line5+26] = '		factor = 0' # Cybrex
...
elseif ($choice -eq 5){
    ...
    $content[$line+26] = '		factor = 0' # Vultaum
    $content[$line2+27] = '		factor = 1' # Yuht
    $content[$line3+26] = '		factor = 0' # First League
    $content[$line4+26] = '		factor = 0' # Irassians
    $content[$line5+26] = '		factor = 0' # Cybrex
    $content | Set-Content -Path $file
